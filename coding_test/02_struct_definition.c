 ...
 * 
 * 출력 정렬 참고:
 * - Windows 콘솔에서 UTF-8 특수문자와 한글이 폭이 다르게 표시됨
 * - ASCII 문자(+, -, |)를 사용하여 정렬 일관성 유지
 * - 한글은 전각(2칸), 영문은 반각(1칸)이므로 공백 계산 필요
 */
 ...
 * 
 * 출력 정렬 참고:
 * - ASCII 박스 문자 사용으로 Windows 콘솔 호환성 확보
 */
 ...
 */
static void demonstrateStructPadding(void) {
